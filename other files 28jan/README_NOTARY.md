...
5. **Phase 5 — Validation matrix**
   ...
   - Validates required elements/fields per requirement and evaluates article compliance where mapped.
...
8. **Phase 8 — Final legal decision (go/no-go gate)**
   - Approves or rejects certificate generation based on blocking/critical issues remaining.
